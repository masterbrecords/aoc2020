...
verify_pattern = re.compile(
    r"(byr:((200[0-2])|(19[2-9][0-9]{1}))|iyr:((2020)|(201[0-9]))|eyr:((2030)|(202[0-9]))|hgt:(((19[0-3])|(1[5-8][0-9]{1}))cm|((7[0-6])|(6[0-9])|(59))in)|hcl:#[0-9a-fA-F]{6}|ecl:(amb|blu|brn|gry|grn|hzl|oth)|pid:\d{9}$|cid:.*)")
...
def verify_passport(passport):
    ...
    for item in items:
        if not verify_pattern.match(item.strip()):
            print("{} hat nicht gematched. Passport: '{}'"
                  .format(item, passport))
            return False
    return True
